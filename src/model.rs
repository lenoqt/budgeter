...
impl Default for Budget {
    fn default() -> Self {
        ...
        Self {
            ...
            income: Income {
                members: vec![
                    IncomeMember::new("Ayumi",   330_000, 250_000, 200_000),
                    IncomeMember::new("Gustavo", 480_000, 480_000, 480_000),
                ],
            },
            loans: Loans {
            ...
            personal_expenses: PersonalExpenses {
                items: vec![
                    PersonalExpenseItem { label: "Phone".into(),           amount_a: 3_000,  amount_b: 2_500 },
                    PersonalExpenseItem { label: "Cat insurance".into(),   amount_a: 4_350,  amount_b: 3_100 },
                    PersonalExpenseItem { label: "NISA".into(),            amount_a: 15_000, amount_b: 0     },
                    PersonalExpenseItem { label: "Hair salon".into(),      amount_a: 6_000,  amount_b: 3_500 },
                    PersonalExpenseItem { label: "Netflix".into(),         amount_a: 890,    amount_b: 0     },
                    PersonalExpenseItem { label: "Cat food".into(),        amount_a: 6_500,  amount_b: 0     },
                    PersonalExpenseItem { label: "Lunch".into(),           amount_a: 12_000, amount_b: 0     },
                    PersonalExpenseItem { label: "Saving".into(),          amount_a: 50_000, amount_b: 0     },
                    PersonalExpenseItem { label: "AI/Apple/Google".into(), amount_a: 1_500,  amount_b: 3_500 },
                    PersonalExpenseItem { label: "Transportation".into(),  amount_a: 5_000,  amount_b: 3_000 },
                    PersonalExpenseItem { label: "Others".into(),          amount_a: 20_000, amount_b: 0     },
                ],
            },
            family_expenses: FamilyExpenses {
                items: vec![
                    FamilyExpenseItem::with_ratio("Water",        3_300,  0.40),
                    FamilyExpenseItem::with_ratio("Electricity",  12_000, 0.40),
                    FamilyExpenseItem::with_ratio("Gas",          5_000,  0.40),
                    FamilyExpenseItem::with_ratio("Internet",     8_000,  0.40),
                    FamilyExpenseItem::with_ratio("Grocery",      40_000, 0.40),
                    FamilyExpenseItem::with_ratio("Cats",         30_000, 0.50),
                    FamilyExpenseItem::with_ratio("Eat out",      20_000, 0.50),
                    FamilyExpenseItem::with_ratio("Refrigerator", 9_400,  0.40),
                ],
            },
            other_items: OtherItems {
                items: vec![
                    OtherItem { label: "Property tax".into(),       annual_amount: 200_000, notes: "".into() },
                    OtherItem { label: "Car tax".into(),            annual_amount: 30_500,  notes: "1,001cc~1,500cc".into() },
